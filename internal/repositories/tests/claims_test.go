...
func TestGetAllByIssuerIDOrderBy(t *testing.T) {
	...
	require.NoError(t, err)
	userDID, err := w3c.ParseDID("did:opid:polygon:main:2q2LTxUzBz9BwarePv9yBdUV8eXZK1ffxVKBGAnt2o")
	require.NoError(t, err)
